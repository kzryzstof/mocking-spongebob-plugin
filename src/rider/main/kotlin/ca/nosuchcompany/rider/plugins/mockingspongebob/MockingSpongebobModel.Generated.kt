...
/**
 * #### Generated from [MockingSpongebobModel.kt:8]
 */
class MockingSpongebobModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        const val serializationHash = 1494029169188048558L
        
    }
    override val serializersOwner: ISerializersOwner get() = MockingSpongebobModel
    override val serializationHash: Long get() = MockingSpongebobModel.serializationHash
    ...
    override fun print(printer: PrettyPrinter)  {
        printer.println("MockingSpongebobModel (")
        printer.indent {
    ...
    //deepClone
    override fun deepClone(): MockingSpongebobModel   {
        return MockingSpongebobModel(
...
val Solution.mockingSpongebobModel get() = getOrCreateExtension("mockingSpongebobModel", ::MockingSpongebobModel)



/**
 * #### Generated from [MockingSpongebobModel.kt:10]
 */
enum class MyEnum {
    FirstValue, 
    SecondValue;
...
/**
 * #### Generated from [MockingSpongebobModel.kt:15]
 */
