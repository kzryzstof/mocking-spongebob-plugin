...
namespace JetBrains.Rider.Model
{
  ...
  /// <summary>
  /// <p>Generated from: MockingSpongebobModel.kt:8</p>
  /// </summary>
  public class MockingSpongebobModel : RdExtBase
  {
    //fields
    //public fields
    ...
    internal MockingSpongebobModel (
    ) : this (
    ...
    protected override long SerializationHash => 1494029169188048558L;
  ...
  public static class SolutionMockingSpongebobModelEx
   {
    public static MockingSpongebobModel GetMockingSpongebobModel(this Solution solution)
    {
      return solution.GetOrCreateExtension("mockingSpongebobModel", () => new MockingSpongebobModel());
    }
  }
  
  
  /// <summary>
  /// <p>Generated from: MockingSpongebobModel.kt:10</p>
  /// </summary>
  public enum MyEnum {
    FirstValue,
    SecondValue
  ...
  /// <summary>
  /// <p>Generated from: MockingSpongebobModel.kt:15</p>
  /// </summary>
